...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/rxec84z5/settings/api) and create a token with read rights.
